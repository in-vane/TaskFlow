...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('CREATED', 'UPDATED', 'TASK_MOVED', 'COMMENTED', 'INVITED');
...
-- CreateIndex
CREATE UNIQUE INDEX "boards_project_id_position_key" ON "boards"("project_id", "position");
